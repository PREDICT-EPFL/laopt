...
public:
    ...
    explicit IpoptWrapper(OptProblem &opt_problem) : IpoptProblem(opt_problem)
    {
        ...
        // application->Options()->SetStringValue("derivative_test", "first-order");
...
/**
 * IpoptWrapper2 is depreciated and for quick comparison only.
**/
template<typename OptProblem>
class IpoptWrapper2
{
public:
    ...
    explicit IpoptWrapper2(OptProblem &opt_problem)
    {
        using namespace Ipopt;
    ...
    IpoptProblem &operator()() const { return *problem; }
